...
export type CreatePublishingAccountInput = { name:string; phoneNumber:string; phoneNumberId:string; businessAccountId:string; accessToken:string; dailyLimit:number; priority:number };
export type EmbeddedSignupResult = { name:string; phoneNumber:string; phoneNumberId:string; businessAccountId:string; code:string; dailyLimit:number; priority:number };
