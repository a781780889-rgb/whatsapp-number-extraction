  ...
  return (
    <div ref={menuRef} className="relative z-50 w-full sm:w-fit">
      <button
        ...
        className={`focus-ring flex w-full items-center justify-between gap-3 rounded-2xl px-4 py-3 text-sm font-semibold transition-all duration-200 sm:min-w-64 ${
          isOpen
